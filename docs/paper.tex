...
Our approach to analyze its potential impact was based on clustering internationalized domain names with their counterparts in the Alexa Top 1m web sites ranking.
