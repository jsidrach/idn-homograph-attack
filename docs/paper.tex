...
Domain names were originally designed to support only ASCII characters. The proposal of Internationalized Domain Name IDN) benefits non-English speaking people, however, it also presents the potential vulnerability. In this paper, we would analyze XXX top level .com domain
by the means of clustering possible homograph domains and classify the owner of them.
