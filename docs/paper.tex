...
\usepackage{usenix,url,epsfig,endnotes}
...
\abstract{
The introduction of Internationalized Domain Names made access the web easier to non-English speakers.
However, it also opened the possibility of using homograph domain names maliciously.
We analyzed the potential impact of this type of attack, commonly referred to as IDN homograph attack.
Our approach was based on clustering internationalized domain names with their counterparts in the Alexa Top 1m web sites ranking.
The results obtained indicate that there are more than a thousand (at least) IDN homographs among \textit{.com} domains.
Most of them are not being used actively, but they still posses a potential security risk as there are no guarantees they will remain inactive in the future.
}
...
Internationalized Domain Names (IDNs) were proposed back in December 1996 by Martin D\"{u}rst\endnote{\url{https://tools.ietf.org/html/draft-duerst-dns-i18n-00}} for the purpose of letting non-English speakers use Internet without additional restrictions.
...
There are two mayor players trying to prevent this kind of attack, browsers and TLDs.
